...
"""autogenerated by genpy from mqtt_commx/charge_station_notify.msg. Do not edit."""
import codecs
import sys
...
class charge_station_notify(genpy.Message):
  _md5sum = "e6208cf7671e976e6c3061bf8dbdd136"
  _type = "mqtt_commx/charge_station_notify"
...
string timestamp
string version"""
  __slots__ = ['header','code']
  _slot_types = ['mqtt_commx/cmd_Header','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(charge_station_notify, self).__init__(*args, **kwds)
